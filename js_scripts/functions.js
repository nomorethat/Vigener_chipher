$(document).ready(function(){
	...
	function to_encrypt(){
		...
		open_message = normalize_of_open_message(open_message); // нормализация исходного сообщения
		key = normalize_of_key(key); // нормализация ключа
		var key_suquence = form_a_key_sequence(open_message, key); // формирование ключевой последовательности
